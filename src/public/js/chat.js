...
let getUser = fetch('https://cuartero-back-coder-final-production.up.railway.app/api/users/current'). //OBTENEMOS EL USER MEDIANTE UN FETCH AL CURRENT , QUE LEE LA COOKIE Y NOS DEVUELVE LA INFO DEL USER
                then(data=>data.json()).
                then(response=>{
                    user = response.email
