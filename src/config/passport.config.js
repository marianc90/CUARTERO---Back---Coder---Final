...
const initializePassport= () => {
    ...
    passport.use('register', new LocalStrategy({
        ...
        const {first_name, last_name, email, age} = req.body;
            ...
            const userTemplate = {
                ...
                age: age,
                cart: await fetch('https://nodecommerce-74al.onrender.com/api/carts', {method:'POST'}).then(res=>res.json()).then(data=> data._id),
                documents: [],
    ...
    passport.use('github', new GitHubStrategy({
        ...
        callbackURL: 'https://nodecommerce-74al.onrender.com/api/users/githubcallback',
        scope:['user:email']
